...
def mirror_matrix_world_across_point(old_matrix_world, mirror_point):
    """
    Point reflection of a transform around mirror_point.

    mirror_point: Vector((x, y, z))
    """

    # Extract transform components
    location, rotation_quaternion, scale = old_matrix_world.decompose()

    # Reflect position about the point
    new_location = mirror_point * 2.0 - location

    # Rebuild matrix using original rotation and scale
    position_matrix = Matrix.Translation(new_location)
